...
Template_id = configs.SG_Templates[configs.announce_tip_mtpublished]
Unsub_id = configs.SG_Unsub_Groups[configs.announce_tip_mtpublished]
...
for email in EMAILS_ALL:
    ...
    dfa_announce_tip = configs.announce_tip_mtpublished
    dfa_channel_type = "email"
    for idno in Users_to_Update.get_user_idnos(email):
        IDNO_Data = Users_to_Update.get_dataload_to_announce_mtpublished(email, idno)
        ...
        for idx in range(len(IDNO_Data)):
            ...
            OCID_Publ = str(IDNO_Data["published"][idx])
            ...
            template_dict = {"user_name":dfa_user_name,"Inst_Name":Inst_Name, "Inst_IDNO":Inst_IDNO,
                "OCID_ocid":OCID_ocid, "OCID_Title":OCID_Title, "OCID_Publ":OCID_Publ,
            ...
            [dfa_raion],[Inst_IDNO],[dfa_announce_tip],[OCID_ocid],[OCID_Publ],[" "],\
